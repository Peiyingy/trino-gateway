            ...
            RoutingDestination routingDestination)
    {
        ...
        if (response.statusCode() == OK.getStatusCode()) {
            try {
                ...
                routingManager.setRoutingGroupForQueryId(queryDetail.getQueryId(), routingDestination.routingDecision());
        ...
        queryDetail.setRoutingGroup(routingDestination.routingDecision());
